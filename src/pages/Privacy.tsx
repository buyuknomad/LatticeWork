  ...
  return (
    <>
      <SEO
        ...
        description="Mind Lattice privacy policy. Learn how we collect, use, and protect your data when using our mental models and cognitive bias analysis tool."
        keywords="mind lattice privacy policy, data protection, user privacy"
        url="/privacy"
      />
